...
const PageSection = ({
  ...
  image,
        ...
        <div className="container small-container">
          ...
          <div className="section-body" dangerouslySetInnerHTML={{__html:content}} />
        </div>
...
const _AboutPage = ({
      ...
      pageSections,
            ...
            <section className="page-header" style={{ backgroundImage: `url(${headerImage})` }}>
  ...
  router: {
    target: {
      model: {
        page:{
          title,
          aboutPageSections: pageSections,
          image: headerImage
        }
      },
    }
